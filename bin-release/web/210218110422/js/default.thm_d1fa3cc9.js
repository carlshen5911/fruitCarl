window.skins=window.skins||{};
	...
	function HomePage() {
		...
		this.height = 480;
		this.width = 640;
		this.elementsContent = [this.17767258b25_i(),this._Image1_i(),this.headerBg_i(),this.headerTitle_i(),this.headerSubTitle_i(),this.headerTip_i(),this.ringDojo_i(),this.ringNewGame_i(),this.ringQuit_i(),this.contentNewGame_i(),this.contentQuit_i(),this.contentDojo_i(),this.contentTip_i()];
	}
	var _proto = HomePage.prototype;

	_proto.17767258b25_i = function () {
		var t = new eui.Config();
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	function JodoPage() {
		...
		this.height = 480;
		this.width = 640;
		this.elementsContent = [this.177672641eb_i(),this._Image1_i(),this.jodoInfo_i()];
	}
	var _proto = JodoPage.prototype;

	_proto.177672641eb_i = function () {
		var t = new eui.Config();
		return t;
	};
	_proto._Image1_i = function () {
	...
	function QuitPage() {
		...
		this.height = 480;
		this.width = 640;
		this.elementsContent = [this.17767278da9_i(),this.quitInfo_i()];
	}
	var _proto = QuitPage.prototype;

	_proto.17767278da9_i = function () {
		var t = new eui.Config();
		return t;
	};
